            ...
            if (msg !== null) {
                ...
                if (routingKey === 'BOOKING_REGISTERED' || routingKey === 'BOOKING_CANCELLED') {
                    Notification.create({
                        ...
                        message: routingKey === 'BOOKING_REGISTERED' 
                ...
                if (routingKey === 'BOOKING_UPDATED') {
                    Notification.create({
                        ...
                        message: `Your booking (ID: ${content.bookingId}) status has been updated to ${content.status || 'updated'}.`
